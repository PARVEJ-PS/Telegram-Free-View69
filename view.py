...
\033[1;33m║══════════════════════════════════║║ NAME ∆ PARVEJ 
\033[1;34m║AUTHOR    : PARVEJ                                                                  
\033[1;35m║══════════════════════════════════║║ MARIAL STATUS ∆ SINGLE
\033[1;36m║WHATSAPP  : 01961049607                                                     
\033[1;37m║══════════════════════════════════║║ PROFESSION ∆ STUDENT
\033[1;38m║GITHUB    : MRNANA                                                            
\033[1;39m║══════════════════════════════════║║ HOME TOWN ∆ RANGPUR   
      
\033[1;31m║SERVER : DATA / WIFI : WORKING.    ╚═════════════════════╝    
\033[1;32m║══════════════════════════════════════════════════════════╗
\033[1;33m║TG Link :https://t.me/@Mr_Dada_King\033[1;32m║
\033[1;34m║══════════════════════════════════════════════════════════║
